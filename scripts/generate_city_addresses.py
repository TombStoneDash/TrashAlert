...
CITIES = {
    ...
    "portland": {
        ...
        "city_name": "Portland",
        "state_abbr": "OR",
        "lat_range": (45.46, 45.60),
        "lon_range": (-122.78, -122.58),
        "streets": [
            "BURNSIDE ST", "BROADWAY", "HAWTHORNE BLVD", "DIVISION ST",
            "POWELL BLVD", "SANDY BLVD", "MLK JR BLVD", "INTERSTATE AVE",
            "ALBERTA ST", "MISSISSIPPI AVE", "WILLIAMS AVE", "VANCOUVER AVE",
            "BELMONT ST", "STARK ST", "MORRISON ST", "ALDER ST",
            "WASHINGTON ST", "YAMHILL ST", "TAYLOR ST", "SALMON ST",
            "GLISAN ST", "COUCH ST", "DAVIS ST", "EVERETT ST",
            "FREMONT ST", "KILLINGSWORTH ST", "LOMBARD ST", "PRESCOTT ST",
            "WOODSTOCK BLVD", "FOSTER RD",
        ],
    },
    "minneapolis": {
        "city_id": 23,
        ...
        "state_abbr": "MN",
        "lat_range": (44.89, 45.05),
        "lon_range": (-93.35, -93.20),
        "streets": [
            "HENNEPIN AVE", "NICOLLET AVE", "LYNDALE AVE", "LAKE ST",
            "FRANKLIN AVE", "BROADWAY AVE", "WASHINGTON AVE", "UNIVERSITY AVE",
            "CENTRAL AVE", "LOWRY AVE", "PLYMOUTH AVE", "OLSON MEMORIAL HWY",
            "MARQUETTE AVE", "2ND AVE S", "3RD AVE S", "PORTLAND AVE",
            "PARK AVE", "CHICAGO AVE", "BLOOMINGTON AVE", "CEDAR AVE",
            "MINNEHAHA AVE", "HIAWATHA AVE", "46TH ST", "38TH ST",
            "EXCELSIOR BLVD", "LAGOON AVE", "UPTOWN AVE", "GRANT ST",
            "1ST AVE N", "GLENWOOD AVE",
        ],
    },
    "detroit": {
        "city_id": 24,
        "city_name": "Detroit",
        "state_abbr": "MI",
        "lat_range": (42.29, 42.45),
        "lon_range": (-83.20, -82.95),
        "streets": [
            "WOODWARD AVE", "MICHIGAN AVE", "GRATIOT AVE", "GRAND RIVER AVE",
            "JEFFERSON AVE", "FORT ST", "VERNOR HWY", "LIVERNOIS AVE",
            "GRAND BLVD", "CASS AVE", "2ND AVE", "3RD AVE",
            "GRISWOLD ST", "SHELBY ST", "WASHINGTON BLVD", "ADAMS ST",
            "MONROE ST", "CONGRESS ST", "LARNED ST", "LAFAYETTE BLVD",
            "BAGLEY ST", "TRUMBULL AVE", "ROSA PARKS BLVD", "DEXTER AVE",
            "JOY RD", "WARREN AVE", "TIREMAN AVE", "FENKELL AVE",
            "PLYMOUTH RD", "DAVISON AVE",
        ],
    },
    "atlanta": {
        "city_id": 25,
        "city_name": "Atlanta",
        "state_abbr": "GA",
        "lat_range": (33.70, 33.85),
        "lon_range": (-84.45, -84.33),
        "streets": [
            "PEACHTREE ST", "PEACHTREE RD", "PIEDMONT AVE", "PONCE DE LEON AVE",
            "NORTH AVE", "BOULEVARD", "MORELAND AVE", "DEKALB AVE",
            "EDGEWOOD AVE", "AUBURN AVE", "MARIETTA ST", "SPRING ST",
            "TECHWOOD DR", "LUCKIE ST", "CENTENNIAL OLYMPIC PARK DR", "BAKER ST",
            "HARRIS ST", "RALPH MCGILL BLVD", "FREEDOM PKWY", "MONROE DR",
            "HIGHLAND AVE", "VIRGINIA AVE", "EUCLID AVE", "MCLENDON AVE",
            "MEMORIAL DR", "FLAT SHOALS AVE", "GLENWOOD AVE", "GRANT ST",
            "CAPITOL AVE", "PRYOR ST",
        ],
    },
    "miami": {
        "city_id": 26,
        "city_name": "Miami",
        "state_abbr": "FL",
        "lat_range": (25.72, 25.86),
        "lon_range": (-80.28, -80.14),
        "streets": [
            "BISCAYNE BLVD", "COLLINS AVE", "FLAGLER ST", "CALLE OCHO",
            "CORAL WAY", "BRICKELL AVE", "S MIAMI AVE", "N MIAMI AVE",
            "NE 2ND AVE", "NW 7TH ST", "NW 27TH AVE", "NW 36TH ST",
            "SW 8TH ST", "SW 1ST ST", "SE 1ST AVE", "WASHINGTON AVE",
            "OCEAN DR", "ALTON RD", "MERIDIAN AVE", "LINCOLN RD",
            "ARTHUR GODFREY RD", "INDIAN CREEK DR", "PINE TREE DR", "PRAIRIE AVE",
            "BAYSHORE DR", "GRAND AVE", "COMMODORE PLAZA", "MAIN HWY",
            "BIRD RD", "DIXIE HWY",
        ],
    },
}
